            ...
            <main class="my-8">
                <div class="container mx-auto px-6">
                    <div class="md:flex md:items-center">
                        <div class="w-800">
                            <img src="{{ asset('assets/MobilTest.svg') }}" alt="" class="w-full">
                        </div>
                        <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                            <h3 class="text-gray-700 uppercase text-lg">
                                320i
                            </h3>
                            <span class="text-gray-500 mt-3">Rp. <span>100.000.000</span></span>
                            <hr class="my-3" />
                            <div class="mt-3">
                                <label class="text-gray-700 text-sm" for="count">Deskripsi</label>
                                <div class="flex items-center mt-1 text-gray-500">
                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quidem praesentium iste vitae,
                                    quas fuga nesciunt beatae expedita ut aliquid quaerat?
                                </div>
                            </div>
